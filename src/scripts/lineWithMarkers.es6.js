...
export var lineWithMarkersChart = function() {
  "use strict";
  //============================================================
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var dataLines = data.filter(function(d) { return !d.disabled && d.values.length > 1 });
  ...
  d3.rebind(chart, lines, 'defined', 'interpolate');
