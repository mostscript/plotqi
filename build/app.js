...
/***/ function(module, exports, __webpack_require__) {
	...
	/*jshint esnext:true, eqnull:true */
	/*globals require */
	var getObjects = __webpack_require__(7).getObjects;
	var Chart = __webpack_require__(8).Chart;
	var SmallMultiplesChart = __webpack_require__(9).SmallMultiplesChart;
	var LargeChart = __webpack_require__(10).LargeChart;
	var nv = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var Klass = __webpack_require__(15).Klass;
	var dataSym = Symbol();
	var d3 = __webpack_require__(5);

	var dataPointSchema = __webpack_require__(16).dataPointSchema;
	var timeDataPointSchema = __webpack_require__(16).timeDataPointSchema;
	var dataSeriesSchema = __webpack_require__(16).dataSeriesSchema;
	var timeDataSeriesSchema = __webpack_require__(16).timeDataSeriesSchema;
	var multiSeriesChartSchema = __webpack_require__(16).multiSeriesChartSchema;
	var timeSeriesChartSchema = __webpack_require__(16).timeSeriesChartSchema;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(5);
	var nv = __webpack_require__(17);
	var shapePath = __webpack_require__(14).shapePath;
	var shapes = __webpack_require__(14).shapes;
	var legendMarkers = __webpack_require__(14).legendMarkers;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moment = __webpack_require__(2);
	var nv = __webpack_require__(17);
	var styleSheet = __webpack_require__(7).styleSheet;
	var timeLineChart = __webpack_require__(11).timeLineChart;
	var timeBarChart = __webpack_require__(12).timeBarChart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nv = __webpack_require__(17);
	var styleSheet = __webpack_require__(7).styleSheet;
	var debounce = __webpack_require__(7).debounce;
	var d3textWrap = __webpack_require__(7).d3textWrap;
	var colorIsDark = __webpack_require__(7).colorIsDark;

	function timeLineChart(mschart, node) { return function() {
	  ...
	  var timeOffset = function(date, n) {
	    return time.offset(date, n * timeStep);
	  };
	  var timeRange = function(start, stop) {
	    return time.range(start, stop, timeStep);
	  };

	  var domain = [ timeOffset(mschart.domain[0], -1), timeOffset(mschart.domain[1], +1) ];
	  var tickVals = timeRange(domain[0], timeOffset(domain[1], +1) ).map( function(date) {
	    return date.valueOf();
	  } );
	  ...
	  function render() {
	    ...
	    function tabularLegend() {
	      ...
	      legWrap.selectAll('.nv-leg-row').filter( function(d, i) {
	        return i > 0;
	      } ).selectAll('text').filter( function(d, i) {
	        return i > 0;
	      } )
	  ...
	  el.append('circle')
	    ...
	    .attr('r', 8)
	    .on('click', function() {
	    return (el.remove(), d3.event.stopPropagation());
	  });
	  el.append('path')
...
/***/ function(module, exports, __webpack_require__) {
	...
	function timeBarChart(mschart, node) { return function() {
	  var relative = (mschart.width_units == '%');
	  var margins = mschart.margins;
	    ...
	    function tabularLegend() {
	      ...
	      legend.each(function (d, i) {
	        ...
	        if(i === 0) {
	          ...
	          cells.transition().duration(500)
	               .attr('transform', function(d) {
	            return "translate(" + (margins.left - legLeftPadding + xscale(d.x) + xInterval / 2) + ", 0)";
	          } )
	               .style('font-family', intervalX <= 25 ? 'silkscreennormal' : null)
	               .style('font-size', intervalX <= 25 ? '6pt' : intervalX <= 35 ? '11px' : null)
	               .attr('textLength', intervalX <= 50 ? intervalX : null)
	          ...
	          cells.transition().duration(500)
	               .attr('x', function(d, i) {
	            return i === 0 ? legLeftPadding : margins.left - legLeftPadding + xscale(d) + (xInterval / 2);
	          } )
	               .attr('textLength', function(d, i) {
	            return i === 0 ? null : (d3.select(this).text().length <= 3 || intervalX > 35) ? null :
	                 (d3.select(this).text().length <= 4 && intervalX > 30) ? null : intervalX - (intervalX >= 20 ? 8 : 5);
	  ...
	  function onPtClick(xInterval) {
	    return function(d) {
	      return showClickPopup.apply(xInterval, calcDataPosition(d));
	    };
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__Object$create = Object.create;
	var $__Object$getPrototypeOf = Object.getPrototypeOf;
	var Schema = __webpack_require__(15).Schema;
	var schematize = __webpack_require__(15).schematize;
	var ValidationError = __webpack_require__(15).ValidationError;
	var ValidationTypeError = __webpack_require__(15).ValidationTypeError;
	var moment = __webpack_require__(2);
